...
const howToSlides = [
  ...
  {kicker:"Tour complete",title:"Return to First Flight",body:"You now know the daily flow: assess, train, debrief, recover, and adapt. Next, First Flight will help you build workout locations, set your your current mission, and choose your coaching voice.",bullets:["Set up every place you regularly train.","Choose the mission Bell Performance should coach right now.","Review the setup and launch Bell Performance."],image:"./assets/artwork/engine/alpine-lake.jpg?v=707",visual:"Continue Setup",detail:"The tour can be replayed anytime from Help.",screen:"home",target:".strength-location-control"}
];
let howToIndex=0;
let howToTimer=null;
