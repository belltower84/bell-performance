...
function renderActiveWorkout() {
  ...
  active.exercises.forEach((exercise,exerciseIndex)=>{
    ...
    card.innerHTML=`
      ...
      <div class="set-table-wrap"><div class="set-head"><span>${isEngine?"Round":"Set"}</span><span>${isEngine?"Target":"Weight"}</span><span>${isEngine?"Result":"Reps"}</span><span>Done</span></div><div id="sets-${exerciseIndex}"></div></div>
