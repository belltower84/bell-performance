"use strict";
const CACHE_NAME = "bell-performance-13-21-7-superset-paired-round-alignment";
const APP_SHELL = [
  "./",
  "./index.html",
  "./manifest.json",
  ...
  "./css/guided-workout-paired-rounds-13217.css?v=132170",
  ...
  "./js/guided-workout-13217.js?v=132170",
