"use strict";
const CACHE_NAME = 'bell-performance-13-20-7-superset-feedback-gate';
const CORE = [
  "./",
  "./index.html",
  "./css/workout-preview-warmup-13207.css",
  "./js/workout-preview-warmup-13207.js",
  "./manifest.json",
  "./css/app.css?v=13710",
