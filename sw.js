"use strict";
const CACHE_NAME = 'bell-performance-13.6.0-readiness-control-modes';
const CORE = [
  "./",
  "./index.html",
  "./manifest.json",
  ...
  "./js/storage.js?v=13600",
  "./js/exercise-library.js?v=10006",
  "./js/readiness.js?v=13600",
  ...
  "./js/dashboard-command-center.js?v=13600",
  ...
  "./css/bell135.css?v=13600",
  "./js/bell13-commercial-home.js?v=13600",
];
